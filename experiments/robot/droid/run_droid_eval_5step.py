...
from experiments.robot.openvla_utils import get_processor, hf_to_vllm, PromptManager5step
...
class GenerateConfig:
    ...
    instruction: str = "pick up the white baseball and put it in the basket"        # Instruction for the task
