...
from experiments.robot.openvla_utils import get_processor, hf_to_vllm, PromptManagerAsyncBase
...
class GenerateConfig:
    ...
    instruction: str = "pick up the blue hammer and put it in the basket"        # Instruction for the task
